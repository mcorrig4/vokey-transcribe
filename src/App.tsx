...
import { UiState, Status } from './types'
...
function App() {
  ...
  return (
    <div
      className={`hud-container${uiState.status === 'recording' ? ' recording' : ''}`}
    ...
    >
      ...
      <button className="hud-settings-btn" onMouseDown={(e) => e.stopPropagation()} onClick={openSettings} aria-label="Settings" title="Settings">
