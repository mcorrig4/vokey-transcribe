...
export function setupDefaultTauriMocks(): void {
  mockInvokeMany({
    ...
    mark_kwin_prompted: undefined,
    install_kwin_rule: undefined,
    get_admin_key_status: { has_key: false },
    validate_admin_api_key: true,
    set_admin_api_key: undefined,
    fetch_usage_metrics: null,
    get_cached_usage_metrics: null,
    open_logs_folder: undefined,
    open_recordings_folder: undefined,
  })
}
